...
from src.get_device_systems import get_pv_sys, get_wind_sys, get_bess_io_sys, get_bess_energy_sys, get_sc_energy_sys
...
if __name__ == '__main__':
    ...
    def get_io_dict():
        return {'PV': (get_pv_sys(), 'lpf', 1),
                ...
                'BESS': (get_bess_energy_sys(e_max=1.5), 'hpf', 1.5)
                }
