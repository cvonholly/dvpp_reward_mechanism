...
K_errors = 3 # test # 20  # number of scenarios for the uncertainty
REL = .1
WIND_CAP = 216 * REL
SOLAR_CAP = 150 * REL
BATTERY_CAP = 150 * REL
...
if __name__ == '__main__':
    ...
    # end_date = pd.to_datetime('2025-04-12 23:00:00')
    # test for now only one day
    end_date = pd.to_datetime('2025-04-06 23:00:00')
    save_path = 'pics/v_update_120126_mp'
    ...
    while current_start < end_date:
        current_end = current_start + pd.Timedelta(hours=12) - pd.Timedelta(seconds=1)
