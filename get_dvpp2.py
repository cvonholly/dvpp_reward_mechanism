...
ti, ta, = 2, 30
Dp = 1   # set to 1MW (or 1 per unit)
RP_MAX = 1/Dp * 3  # max power for FCR
T_MAX_FCR = 60
...
# combined FCR-FFR
curve_ffrfcr_min = curve_fcr_min + create_curve(require_ffr, t_max=T_MAX_FCR)[1]
input_ffrfcr_max = input_fcr_max + create_curve(require_ffr_max, t_max=T_MAX_FCR)[1]
